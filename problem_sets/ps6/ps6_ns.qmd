...
waze_combo_df.fillna("Missing", inplace= True) # without this, NA is dropped
...
1) There are 4 types that have a subtype NA ("missing" in my code)
2) There are several columns that we can reasonable see containing sub-subtypes, 
